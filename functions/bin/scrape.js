...
(async function main () {
  ...
  for(let selectedYear = 1990; selectedYear <= MAX_YEAR; selectedYear++) {
    ...
    fs.writeFile("./data/" + selectedYear + ".json", jsonContent, 'utf8', function (err) {
      if (err) {
          return console.log(err);
      }

      console.log("The file was saved for the year " + selectedYear + "!");
      console.log('Waiting before requesting more data');
    }); 
